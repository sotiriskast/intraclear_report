    ...
    <div className="p-6">
        ...
        {redirectUrl ? (
            <button onClick={() => window.location.href = redirectUrl}
                    className="mt-4 inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                Go to Login Page
            </button>
        ) : (
