                        ...
                        <div class="border-b last:border-b-0 px-4 py-4 hover:bg-gray-50">
                            ...
                            <span class="text-indigo-700 font-medium text-sm">
                                ...
                                <div class="flex space-x-2">
                                    ...
                                    <button wire:click="$dispatch('deleteUser', { userId: {{ $user->id }} })"
                            ...
                            <div class="mt-2">
                                <p class="text-xs font-medium text-gray-700 mb-1">Roles:</p>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap hidden sm:table-cell">
                                    <div class="flex flex-wrap gap-2">
                                        @foreach($user->roles as $role)
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $role->name === 'admin' ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800' }}">
                                        {{ $role->name }}
                                    </span>
                                        @endforeach
                                    </div>
            ...
            <x-dialog-modal wire:model.live="showCreateModal" max-width="2xl">
                ...
                <x-slot name="footer">
                    <div class="flex justify-end space-x-3">
                        ...
                        <x-button wire:click="$dispatch('{{ $isEditing ? 'updateUser' : 'createUser' }}')"
