<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @if (session('success'))
                <div class="mb-4 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-sm relative">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-4">
                                <div class="flex items-center">
                                    <input type="text" id="api-key" value="{{ session('newApiKey') }}" readonly class="flex-1 p-2 border border-gray-300 rounded-sm mr-2 bg-gray-50 text-gray-800 font-mono text-sm">
                                    <button onclick="copyApiKey()" class="px-3 py-2 bg-gray-200 text-gray-700 rounded-sm hover:bg-gray-300 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            ...
            <div class="bg-white overflow-hidden shadow-xs sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="bg-gray-50 p-4 rounded-sm border mb-4">
                        <div class="flex items-center">
                            <div class="shrink-0">
                                @if($hasApiKey)
                    ...
                    <div class="bg-gray-50 p-4 rounded-sm border">
                        <div class="flex items-center">
                            <div class="shrink-0">
                        ...
                        <div class="flex space-x-2">
                            ...
                            @if($tokenCount > 0)
                                <form method="POST" action="{{ route('merchant.api.revoke', $merchant) }}" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-xs text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-red-500" onclick="return confirm('Are you sure you want to revoke all API tokens? This will log out all API sessions.')">
                                        <svg class="-ml-1 mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="mt-6 bg-white overflow-hidden shadow-xs sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <pre class="mt-1 block w-full p-2 border border-gray-200 rounded-sm bg-gray-50 text-sm font-mono">{{ config('app.url') }}/api/v1</pre>
                        </div>

                        <div>
                            <h4 class="font-medium text-gray-700">Account ID</h4>
                            <pre class="mt-1 block w-full p-2 border border-gray-200 rounded-sm bg-gray-50 text-sm font-mono">{{ $merchant->account_id }}</pre>
                        </div>

                        <div>
                            <h4 class="font-medium text-gray-700">API Endpoints</h4>
                            <div class="mt-2 space-y-2 text-sm">
                                <div class="p-2 bg-gray-50 rounded-sm border">
